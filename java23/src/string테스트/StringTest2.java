...
public class StringTest2 {
	...
	public static void main(String[] args) {
		...
		System.out.println(s7.lastIndexOf("/"));//마지막 /의 자리를 알려준다.
		...
		System.out.println(s9.contains("hello"));//s9에 포함하고있는지 여부
		System.out.println(s9.startsWith("winner"));//winner로 시작하는지 여부
		System.out.println(s9.endsWith("class"));//class로 끝나는지 여부
		String s10 = "hera@anver.com";
