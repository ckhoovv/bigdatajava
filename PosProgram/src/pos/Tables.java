...
public class Tables extends JFrame{
	...
	private void table_bg(String str) {	
		...
		title_table.setBounds(12, 26, 917, 95);
	...
	private void jtableset() {
		...
		jScollPane.setLocation(558, 208);
	...
	private void menu_bt(String str, PosMain posmain) {
		mainmenubt.setBounds(12, 131, 93, 70);
		getContentPane().add(mainmenubt);
		...
		mainmenubt.setForeground(SystemColor.desktop);
		mainmenubt.setFont(new Font("Dialog", Font.BOLD, 19));
		sidemenubt.setBounds(121, 131, 93, 70);
		getContentPane().add(sidemenubt);
		...
		sidemenubt.setForeground(Color.MAGENTA);
		sidemenubt.setFont(new Font("Dialog", Font.BOLD, 19));
		drinkbt.setBounds(342, 131, 93, 70);
		getContentPane().add(drinkbt);

		
		drinkbt.setBackground(new Color(255, 218, 185));
		drinkbt.setForeground(Color.CYAN);
		drinkbt.setFont(new Font("Dialog", Font.BOLD, 19));
		...
		sojubt.setBounds(453, 131, 93, 70);
		getContentPane().add(sojubt);
		...
		sojubt.setFont(new Font("Dialog", Font.BOLD, 19));
		anjubt.setBounds(234, 131, 93, 70);
		getContentPane().add(anjubt);

		
		anjubt.setBackground(new Color(255, 218, 185));
		anjubt.setForeground(Color.ORANGE);
		anjubt.setFont(new Font("Dialog", Font.BOLD, 19));
		...
		order_bt.setBackground(new Color(255, 255, 224));
		...
		order_bt.setBounds(558, 706, 151, 86);
		...
		cancel_bt.setBackground(new Color(255, 255, 224));
		...
		cancel_bt.setBounds(778, 706, 151, 86);
