...
public class Main {
	...
	Main() {
		...
		b6.setFont(new Font("굴림", Font.BOLD, 15));
		...
		b7.setFont(new Font("굴림", Font.BOLD, 15));
		...
		b8.setFont(new Font("굴림", Font.BOLD, 15));
		...
		b9.setFont(new Font("굴림", Font.BOLD, 15));
		...
		b10.setFont(new Font("굴림", Font.BOLD, 15));
		...
		b11.setFont(new Font("굴림", Font.BOLD, 15));
		...
		b12.setFont(new Font("굴림", Font.BOLD, 15));
